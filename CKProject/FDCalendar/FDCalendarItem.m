...
- (instancetype)init {
    if (self = [super init]) {
        ...
        [self setFrame:CGRectMake(0, 0, DeviceWidth-DeviceWidth/8, self.collectionView.frame.size.height + CollectionViewVerticalMargin * 2)];
    }
    return self;
}
...
- (void)setupCollectionView {
    CGFloat itemWidth = (DeviceWidth-DeviceWidth/8 - CollectionViewHorizonMargin * 2) / 7;
    ...
    CGRect collectionViewFrame = CGRectMake(CollectionViewHorizonMargin, CollectionViewVerticalMargin, DeviceWidth-DeviceWidth/8 - CollectionViewHorizonMargin * 2, itemHeight * 5  );
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.dayLabel.layer setBorderColor:[UIColor clearColor].CGColor];
    [cell.dayLabel.layer setBorderWidth:0];
    ...
    if (indexPath.row < firstWeekday) {    // 小于这个月的第一天
       ...
       // cell.chineseDayLabel.text = [self chineseCalendarOfDate:[self dateOfMonth:FDCalendarMonthNext WithDay:day]];
        ...
        if (day == [[NSCalendar currentCalendar] component:NSCalendarUnitDay fromDate:self.date]) {
            ...
            cell.dayLabel.layer.cornerRadius = cell.dayLabel.frame.size.height / 2;
            cell.layer.masksToBounds=true;
            [cell.dayLabel.layer setBorderColor:[UIColor colorWithRed:1 green:99.f/255.f blue:99.f/255.f alpha:1.0f].CGColor];
            [cell.dayLabel.layer setBorderWidth:2];
            cell.dayLabel.textColor = [UIColor colorWithRed:1 green:99.f/255.f blue:99.f/255.f alpha:1.0f];
