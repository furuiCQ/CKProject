...
-(void)setImageDeselected:(NSString *)deselectedName halfSelected:(NSString *)halfSelectedName fullSelected:(NSString *)fullSelectedName andDelegate:(id<RatingBarDelegate>)delegate{
    ...
    [_s2 setFrame:CGRectMake(width+paddingWidth,     0, width, height)];
    [_s3 setFrame:CGRectMake(2 * width+paddingWidth*2, 0, width, height)];
    [_s4 setFrame:CGRectMake(3 * width+paddingWidth*3, 0, width, height)];
    [_s5 setFrame:CGRectMake(4 * width+paddingWidth*4, 0, width, height)];
    ...
    frame.size.width = width * 5+paddingWidth *4;
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    int newRating = (int) (point.x / (width+paddingWidth)) + 1;
    if (newRating > 5)
        return;
